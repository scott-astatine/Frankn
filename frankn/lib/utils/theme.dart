  ...
  static ThemeData get themeData {
    return ThemeData(
      ...
      textTheme: const TextTheme(
        ...
        titleMedium: TextStyle(fontWeight: FontWeight.bold, color: AppColors.neonCyan),
        bodyMedium: TextStyle(fontSize: 14, color: AppColors.textWhite),
        // Use labelSmall for data labels
        labelSmall: TextStyle(fontFamily: 'JetBrainsMonoNerdFont', letterSpacing: 1, fontSize: 10),
      ),
